...
-- key bindings are set in local scopes variable in config, above; filters are assigned to keys sequentially, so they must remain in order
    filters = {
      ...
      {filter = {'format=yuv444p,split=4[f][y][u][v],[f]il=l=d:c=d[f1],[y]il=l=d,extractplanes=y[y1],[u]il=c=d,extractplanes=u[u1],[v]il=c=d,extractplanes=v[v1],[f1][y1][u1][v1]hstack=4'}}, --6 split fields/planes view --add padding
