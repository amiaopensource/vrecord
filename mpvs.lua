...
local display = 0
local last_key = 1
local defaultfont = "/Library/Fonts/Papyrus.ttc"
local hue = 20
local sat = 0.3
local scopes = {
...
local function getBind(key, index)
  return function()  -- onKey
    ...
    filters = {
      ...
      {filter = {'split=7[a][b][c][d][e][f][g],[b]field=top[b1],[c]field=bottom[c1],[b1]format=yuv422p,waveform=c='..comp..':d='..disp..':f='..filW..':g='..grat..':e='..env..':fl=numbers+dots:s=ire:i='..intensity..',scale=iw:256[b2],[c1]format=yuv422p,waveform=c='..comp..':d='..disp..':f='..filW..':g='..grat..':e='..env..':fl=numbers+dots:s=ire:i='..intensity..',scale=iw:256[c2],[a][b2][c2]vstack=inputs=3,format=yuv422p[abc1],[d]format=yuv422p,vectorscope=m='..filV..':g='..grat..':e='..env..':i='..intensity..':c=601,scale=512:512[d1],[e]signalstats=out=brng,scale=512:ih[e1],[e1][d1]vstack[de1],[f]signalstats=stat=brng+vrep+tout,format=yuv422p,geq=lum=60:cb=128:cr=128,scale=180:ih+512,setsar=1/1,drawtext=fontcolor=white:fontsize=22:fontfile=/Library/Fonts/Papyrus.ttc:textfile=/tmp/drawtext.txt,drawtext=fontcolor=white:fontsize=17:fontfile=/Library/Fonts/Papyrus.ttc:textfile=/tmp/drawtext2.txt,drawtext=fontcolor=white:fontsize=52:fontfile=/Library/Fonts/Papyrus.ttc:textfile=/tmp/drawtext3.txt[f1],[abc1][de1][f1]hstack=inputs=3[abcdef1],[g]scale=iw+512+180:82,format=yuv422p,geq=lum=60:cb=128:cr=128,drawtext=fontcolor=white:fontsize=22:fontfile=/Library/Fonts/Papyrus.ttc:textfile=/tmp/vrecord_input.log:reload=1:y=82-th[g1],[abcdef1][g1]vstack'}}, --3 v+n
